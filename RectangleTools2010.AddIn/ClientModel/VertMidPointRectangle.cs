...
{
    public class VertMidPointRectangle : Rectangle, IRectangleLogic, IChangeProcessorParent
    {
        ...
        {
            _upperLeftPoint2d.X = _upperRightPoint2d.X - ((_upperRightPoint2d.X - _pickedPoint2d.X) * 1);
        ...
        protected override void ConstrainRectangle()
        {
            if (_planarSketch != null)
            {
                ...
                _planarSketch.GeometricConstraints.AddMidpoint(_rectangleOriginSketchPoint, _rectangleLines[1]);
            }
            ...
            else if (_drawingSketch != null)
            {
                ...
                _drawingSketch.GeometricConstraints.AddPerpendicular((SketchEntity)_rectangleLines[2],
                    (SketchEntity)_rectangleLines[3]);
                _drawingSketch.GeometricConstraints.AddMidpoint(_rectangleOriginSketchPoint, _rectangleLines[1]);
            }
        }
    }
}
