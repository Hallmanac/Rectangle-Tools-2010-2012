...
{
    public class CenterPointRectangle : Rectangle, IRectangleLogic, IChangeProcessorParent
    {
        ...
        protected override void ConstrainRectangle()
        {
            if (_planarSketch != null)
            {
                ...
                //Create Sketch Points for the midpoints of the _rectangleLines[3] and _rectangleLines[2]
                _verticalMidPointAlign = _planarSketch.SketchPoints.Add(_rectangleLines[2].Geometry.MidPoint, false);
                _planarSketch.GeometricConstraints.AddMidpoint(_verticalMidPointAlign, _rectangleLines[2]);

                _horizontalMidPointAlign = _planarSketch.SketchPoints.Add(_rectangleLines[3].Geometry.MidPoint, false);
                _planarSketch.GeometricConstraints.AddMidpoint(_horizontalMidPointAlign, _rectangleLines[3]);
                ...
                _planarSketch.GeometricConstraints.AddHorizontalAlign(_rectangleOriginSketchPoint, _horizontalMidPointAlign);
                _planarSketch.GeometricConstraints.AddVerticalAlign(_rectangleOriginSketchPoint, _verticalMidPointAlign);
            }
            ...
            else if (_drawingSketch != null)
            {
                ...
                //Create Sketch Points for the midpoints of the _rectangleLines[3] and _rectangleLines[2]
                _verticalMidPointAlign = _drawingSketch.SketchPoints.Add(_rectangleLines[3].Geometry.MidPoint, false);
                _drawingSketch.GeometricConstraints.AddMidpoint(_verticalMidPointAlign, _rectangleLines[3]);

                _horizontalMidPointAlign = _drawingSketch.SketchPoints.Add(_rectangleLines[2].Geometry.MidPoint, false);
                _drawingSketch.GeometricConstraints.AddMidpoint(_horizontalMidPointAlign, _rectangleLines[2]);
                ...
                _drawingSketch.GeometricConstraints.AddPerpendicular((SketchEntity)_rectangleLines[2],
                    (SketchEntity)_rectangleLines[3]);
                _drawingSketch.GeometricConstraints.AddHorizontalAlign(_rectangleOriginSketchPoint, _verticalMidPointAlign);
                _drawingSketch.GeometricConstraints.AddVerticalAlign(_rectangleOriginSketchPoint, _horizontalMidPointAlign);
            }
        }
