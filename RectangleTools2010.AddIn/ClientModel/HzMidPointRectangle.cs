...
{
    class HzMidPointRectangle : Rectangle, IRectangleLogic, IChangeProcessorParent
    {
        public HzMidPointRectangle(IInventorButton rectangleButton, Inventor.Application inventorApplication = null)
        {
            _inventorApplication = inventorApplication;
            _rectangleButton = rectangleButton;
            _changeProcessor = new QubeItToolsChangeProcessor(_inventorApplication, this, 
                "HzMidPtRect", "Horizontal Mid-Point Rectangle", StandardAddInServer.AddInServerId);
        ...
        protected override void PositionPoint2dObjects()
        {
            ...
            _lowerLeftPoint2d.Y = _upperLeftPoint2d.Y - ((_upperLeftPoint2d.Y - _pickedPoint2d.Y) * 1);
        ...
        protected override void ConstrainRectangle()
        {
            if (_planarSketch != null)
            {
                ...
                _planarSketch.GeometricConstraints.AddMidpoint(_rectangleOriginSketchPoint, _rectangleLines[2]);
            }
            ...
            else if (_drawingSketch != null)
            {
                ...
                _drawingSketch.GeometricConstraints.AddPerpendicular((SketchEntity)_rectangleLines[2],
                    (SketchEntity)_rectangleLines[3]);
                _drawingSketch.GeometricConstraints.AddMidpoint(_rectangleOriginSketchPoint, _rectangleLines[2]);
            }
        }
    }
}
